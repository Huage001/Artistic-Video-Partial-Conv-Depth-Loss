...
os.system('python test.py --dataroot %s --name %s --model video --no_flip --num_test %d --netG resnet_6blocks --load_size_w %d --load_size_h %d --crop_size_w %d --crop_size_h %d' % (dataroot, name, number, load_size_w, load_size_h, load_size_w, load_size_h))
